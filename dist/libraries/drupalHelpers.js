 ...
 */
const loginDrupal = async (u, uname, pword) => {
 ...
 */
const getQuestions = async (u, csrf, cookies) => {
 ...
 */
const getUpdates = async (u, csrf, cookies) => {
 ...
 */
const getPendingQuestions = async (u, csrf, cookies) => {
 ...
 */
const post2Drupal = async (u, csrf, result) => {
    ...
    try {
        ...
        if (!response.ok) {
            ...
            throw new Error(`Drupal update failed: ${response.status} ${response.statusText}`);
        }
        const data = await response.json();
 ...
 */
const postSimilar2Drupal = async (u, csrf, result) => {
 ...
 */
const logoutDrupal = async (u, lo_token) => {
